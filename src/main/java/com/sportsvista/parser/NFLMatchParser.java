...
public class NFLMatchParser {
    ...
    public List<Match> parseMatches(JsonObject response) {
        ...
        for (JsonElement eEl : events) {
            ...
            match.setSportId(SportRegistry.getId("american_football"));
            
            JsonObject competition = SafeParser.arr(e, "competitions").get(0).getAsJsonObject();
            ...
            if (logo1 == null || logo1.isEmpty()) logo1 = "https://a.espncdn.com/i/teamlogos/nfl/500/" + match.getTeam1ExternalId() + ".png";
            ...
            if (logo2 == null || logo2.isEmpty()) logo2 = "https://a.espncdn.com/i/teamlogos/nfl/500/" + match.getTeam2ExternalId() + ".png";
