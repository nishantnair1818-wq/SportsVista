...
public class BaseballMatchParser {
    ...
    public List<Match> parseMatches(JsonObject response) {
        ...
        for (JsonElement eEl : events) {
            ...
            match.setSportId(SportRegistry.getId("baseball"));
            ...
            if (logo1 == null || logo1.isEmpty()) logo1 = "https://a.espncdn.com/i/teamlogos/mlb/500/" + match.getTeam1ExternalId() + ".png";
            ...
            if (logo2 == null || logo2.isEmpty()) logo2 = "https://a.espncdn.com/i/teamlogos/mlb/500/" + match.getTeam2ExternalId() + ".png";
